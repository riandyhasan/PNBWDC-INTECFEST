...
export default function JoinUs({ ...props }) {
  return (
    <Flex bg="brand.primary" color="brand.tertiary" direction={{ base: "column", md: "row" }} padding="4rem" alignItems={{ base: "flex-start", md: "center" }} justifyContent={{ base: "flex-start", md: "space-between" }} {...props}>
      <Box>
        <Heading>Tertarik Berkontribusi Melalui PlasmaKu?</Heading>
        <Flex maxW="70vw">
          <Text textAlign="justify" marginTop={3}>
            Anda ingin berkontribusi lebih di tengah pandemi? Ayo bergabung bersama tim PlasmaKu dan bantu lebih banyak orang dalam menghadapi COVID-19!
          </Text>
        </Flex>
      </Box>
      <Box>
