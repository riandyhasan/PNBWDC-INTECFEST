...
export default function TentangKamiJumbotron({ ...props }) {
  return (
    <Flex minH={{ base: "60vh", md: "80vh", lg: "88vh" }} minW="100vw" direction="column" alignItems="center" justifyContent="center" bgImg="url('/assets/img/FotoTentangKami.png')" bgRepeat="no-repeat" bgSize="cover" {...props}>
